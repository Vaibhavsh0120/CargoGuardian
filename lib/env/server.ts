...
export function getServerEnv() {
  const env = serverEnvSchema.parse({
    ...
    BLYNK_MQTT_URL: process.env.BLYNK_MQTT_URL,
    ...
    DEMO_BLYNK_AUTH_TOKEN: process.env.DEMO_BLYNK_AUTH_TOKEN,
