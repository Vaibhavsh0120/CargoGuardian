...
import { cargoTypeLabels, trainStatusLabels, type Train, type TrainStatus } from "@/types/train";
      ...
      <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-3xl space-y-3">
          ...
          <div className="space-y-1">
            ...
            {train.description ? (
              <p className="text-sm text-muted-foreground">{train.description}</p>
            ) : null}
          </div>
        </div>
        ...
        <div className="flex shrink-0 items-center gap-4">
          ...
          {train.maxSpeed ? (
            <div className="rounded-2xl border border-border/60 bg-background/70 px-4 py-3 text-center">
              <p className="text-2xl font-bold text-foreground">{train.maxSpeed}</p>
