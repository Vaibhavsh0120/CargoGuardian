...
const features = [
  {
    ...
    description: "Keep pending, granted, and revoked clearance attached to the train record, whether the release happens remotely or through RFID-confirmed workflow.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Weight-Sensitive Safety",
    description: "Track underweight and overweight warning states, surface risk during transit, and preserve alert context on the same train thread.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Live GPS Monitoring",
    description: "Use real telemetry history to derive movement and speed while keeping current location, freshness, and stale states visible.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Role-Scoped Access",
    description: "Let admins manage the fleet, masters coordinate train groups, and workers see only assigned trains before clearance closes their view.",
    visual: "security",
  },
];
...
const aiNodes = [
  { x: "150", y: "80", delay: "0s" },
  { x: "125", y: "123.30127018922192", delay: "0.3s" },
  { x: "75.00000000000001", y: "123.30127018922194", delay: "0.6s" },
  { x: "50", y: "80", delay: "0.9s" },
  { x: "74.99999999999997", y: "36.69872981077808", delay: "1.2s" },
  { x: "125", y: "36.69872981077807", delay: "1.5s" }
] as const;
    ...
    >
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 py-12 lg:py-20 border-b border-foreground/10">
        ...
        <div className="flex-1 grid lg:grid-cols-2 gap-8 items-center">
          <div>
            <h3 className="text-3xl lg:text-4xl font-editorial mb-4 group-hover:translate-x-2 transition-transform duration-500">
              {feature.title}
            </h3>
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Everything the train desk needs.
            <br />
